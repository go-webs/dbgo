...
type WhereClause2 interface {
	Where(column any, args ...any) WhereClause2
	OrWhere(column any, args ...any) WhereClause2
	WhereRaw(sqlSeg string, bindingsAndBoolean ...any) WhereClause2
	OrWhereRaw(sqlSeg string, bindingsAndBoolean ...any) WhereClause2
	BuildWhere() (sql4prepare string, values []any, err error)
	//// null
	//WhereNull(arg string) WhereClause
	//OrWhereNull(arg string) WhereClause
	//WhereNotNull(arg string) WhereClause
